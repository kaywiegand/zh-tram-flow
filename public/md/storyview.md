...
> Was vorhersagbar ist, ist steuerbar. Das Modell bestätigt die Analyse: prev_trip_delay ist das stärkste neue Feature in v2, MAE sinkt von 45.7s auf 18.6s. Fahrplan-Redesign an L11 ist der Hebel.
...
> prev_trip_delay ist das stärkste neue Feature in v2 und erklärt den Sprung von 45.7s auf 18.6s MAE. Das Signal war in den Daten — die EDA hat es zuerst aufgezeigt, das Modell hat es bestätigt.
